...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,755 | 🐛 198 | 🌐 Python | 📅 2026-09-17 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,961 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,300 | 🐛 448 | 🌐 Python | 📅 2026-09-16 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,168 | 🐛 232 | 🌐 Python | 📅 2026-09-18 - Toolkit for adding programmable guardrails to LLM applications.
...
* [TensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,035 | 🐛 136 | 🌐 Python | 📅 2026-08-26 - Library for training ML models with differential privacy.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,495 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-19 - Visualizer for neural network, deep learning, and ML models.
...
* [Model Signing](https://github.com/sigstore/model-transparency) ⭐ 244 | 🐛 49 | 🌐 Python | 📅 2026-09-17 - Supply chain security for ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,386 | 🐛 31 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,866 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-14 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,294 | 🐛 107 | 🌐 Go | 📅 2026-09-18 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,366 | 🐛 319 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,528 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,693 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,189 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,457 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,136 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,211 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,412 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,123 | 🐛 7 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,076 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,570 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
...
* [gau](https://github.com/lc/gau) ⭐ 5,098 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,026 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,796 | 🐛 5 | 🌐 Rust | 📅 2026-09-17 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 949 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes, orchestrating 80+ offensive tools as an MCP host with proof of exploitation and a local privacy gateway (the LLM never sees real IPs or credentials).
* [WebSift](https://github.com/s-r-e-e-r-a-j/WebSift) ⭐ 582 | 🐛 0 | 🌐 Shell | 📅 2026-02-24 - Web reconnaissance tool for gathering information about websites.
...
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 875 | 🐛 65 | 🌐 Go | 📅 2026-06-16 - All-In-One OSINT tool with neat web interface
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,029 | 🐛 2,659 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,627 | 🐛 26 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,745 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,063 | 🐛 214 | 🌐 Python | 📅 2026-09-15 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 10,020 | 🐛 2,155 | 🌐 TypeScript | 📅 2026-09-19 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,724 | 🐛 68 | 🌐 Python | 📅 2026-09-18 - manage your Threat Intelligence at scale
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 741 | 🐛 2 | 🌐 REXX | 📅 2026-09-19 - C2 intelligence feeds for threat hunting.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,060 | 🐛 347 | 🌐 Python | 📅 2026-09-19 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,440 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,835 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - Check a username's presence across popular dev/social/creator sites and games
...
* [Nexfil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,620 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - OSINT tool for finding profiles by username.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,577 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
* [mosint](https://github.com/alpkeskin/mosint) ⭐ 6,032 | 🐛 28 | 🌐 Go | 📅 2024-02-02 - Automated e-mail OSINT tool for gathering information about email addresses.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,835 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
...
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,400 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - All-in-one email OSINT tool. Checks 800+ platforms via Holehe, WhatsMyName, and user-scanner, with breach detection, Hudson Rock infostealer intel, and identity clustering.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,092 | 🐛 116 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
...
* [trape](https://github.com/jofpin/trape) ⭐ 9,012 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
* [Social-Media-OSINT-Tools-Collection](https://github.com/osintambition/Social-Media-OSINT-Tools-Collection) ⭐ 1,987 | 🐛 19 | 📅 2026-01-30 - A collection of most useful osint tools for SOCINT.
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,577 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [GitDorker](https://github.com/obheda12/GitDorker) ⭐ 2,589 | 🐛 22 | 🌐 Python | 📅 2024-08-03 - A Python program to scrape secrets from GitHub through usage of a large repository of dorks.
  <br>
* [Google Dork Cheatsheet](https://github.com/robyfirnandoyusuf/Google-Dork-Cheatsheet) ⭐ 59 | 🐛 0 | 📅 2022-04-11 - google dorks cheatsheet
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,452 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,295 | 🐛 347 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,064 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
* [osi.ig](https://github.com/th3unkn0n/osi.ig) ⭐ 1,565 | 🐛 52 | 🌐 Python | 📅 2024-02-01 - Information Gathering Instagram.
...
* [maltego-telegram](https://github.com/vognik/maltego-telegram/) ⭐ 565 | 🐛 3 | 🌐 Python | 📅 2026-01-27 - OSINT Maltego Transforms for investigating Telegram channels, groups, and users, including deanonymization via stickers, forwarded messages, similar channels, deleted posts, and more.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,351 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,032 | 🐛 159 | 📅 2026-09-18 - A topic-centric list of HQ open datasets.
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,834 | 🐛 2 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,396 | 🐛 89 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,187 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,900 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Dark Web OSINT Tool for crawling and analyzing Tor network.
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,948 | 🐛 9 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,188 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,849 | 🐛 4 | 🌐 Python | 📅 2026-09-18 - Automated OS command injection and exploitation tool.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,189 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,457 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool.
...
* [DNSRecon](https://github.com/darkoperator/dnsrecon) ⭐ 3,069 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - DNS enumeration and scanning tool.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,294 | 🐛 107 | 🌐 Go | 📅 2026-09-18 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,733 | 🐛 1 | 🌐 Perl | 📅 2026-09-18 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,602 | 🐛 9 | 🌐 PHP | 📅 2026-09-18 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,693 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,739 | 🐛 23 | 🌐 Python | 📅 2026-09-19 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,136 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,076 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,580 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,399 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,265 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API endpoint and content discovery tool.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,172 | 🐛 38 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,516 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,795 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,399 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - Runtime mobile exploration toolkit powered by Frida.
...
* [Faraday](https://github.com/infobyte/faraday) ⭐ 6,748 | 🐛 15 | 🌐 Python | 📅 2026-09-17 - Collaborative penetration test and vulnerability management platform.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,911 | 🐛 30 | 📅 2026-03-07 - Curated list of bug bounty resources.
