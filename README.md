...
* [Leaker](https://github.com/vflame6/leaker) ⭐ 584 | 🐛 4 | 🌐 Go | 📅 2026-08-19 - Passive leak enumeration CLI tool that searches across 10 breach databases simultaneously.
...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,703 | 🐛 206 | 🌐 Python | 📅 2026-08-22 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,822 | 🐛 1 | 🌐 Python | 📅 2026-07-22 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
* [Chiasmodon](https://github.com/chiasmod0n/chiasmodon) ⭐ 699 | 🐛 2 | 🌐 Python | 📅 2025-05-10 - Chiasmodon is an OSINT tool designed to assist in the process of gathering information about a target domain. Its primary functionality revolves around searching for domain-related data, including domain emails, domain credentials, CIDRs , ASNs , and subdomains, the tool also allows users to search Google Play application ID.
...
* [Garak](https://github.com/leondz/garak) ⭐ 8,897 | 🐛 404 | 🌐 Python | 📅 2026-08-21 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,996 | 🐛 213 | 🌐 Python | 📅 2026-08-21 - Toolkit for adding programmable guardrails to LLM applications.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,191 | 🐛 19 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,387 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-22 - Visualizer for neural network, deep learning, and ML models.
...
* [Model Signing](https://github.com/sigstore/model-transparency) ⭐ 243 | 🐛 46 | 🌐 Python | 📅 2026-08-17 - Supply chain security for ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,311 | 🐛 33 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,571 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-11 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,653 | 🐛 107 | 🌐 Go | 📅 2026-08-20 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,355 | 🐛 310 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,342 | 🐛 28 | 🌐 Go | 📅 2026-08-17 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,565 | 🐛 231 | 🌐 Go | 📅 2026-08-20 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,020 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,271 | 🐛 1 | 🌐 Go | 📅 2026-08-22 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,011 | 🐛 20 | 🌐 Go | 📅 2026-08-17 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,130 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,311 | 🐛 11 | 🌐 Go | 📅 2026-08-19 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,031 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - Fast, simple, recursive content discovery tool.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,015 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 - Automated reconnaissance tool combining multiple OSINT tools.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,531 | 🐛 7 | 🌐 Go | 📅 2026-08-08 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,380 | 🐛 22 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
...
* [gau](https://github.com/lc/gau) ⭐ 5,071 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,540 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all URLs that the Wayback Machine knows about for a domain.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,000 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,784 | 🐛 24 | 🌐 Rust | 📅 2026-07-28 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,619 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,314 | 🐛 2,602 | 🌐 Python | 📅 2026-08-20 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 28,254 | 🐛 2 | 📅 2026-08-22 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,701 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 10,928 | 🐛 198 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 9,840 | 🐛 2,138 | 🌐 TypeScript | 📅 2026-08-23 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,680 | 🐛 70 | 🌐 Python | 📅 2026-08-20 - manage your Threat Intelligence at scale
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 740 | 🐛 2 | 🌐 REXX | 📅 2026-08-22 - C2 intelligence feeds for threat hunting.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 89,981 | 🐛 334 | 🌐 Python | 📅 2026-08-22 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,807 | 🐛 17 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
...
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 3,273 | 🐛 14 | 🌐 Python | 📅 2026-08-23 - Check a username's presence across popular dev/social/creator sites and games
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,402 | 🐛 74 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
...
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 3,273 | 🐛 14 | 🌐 Python | 📅 2026-08-23 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
...
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,656 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
...
* [Mailcat](https://github.com/sharsil/mailcat) ⭐ 932 | 🐛 0 | 🌐 Python | 📅 2026-05-24 - Find email addresses of a person from their username.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 14,903 | 🐛 112 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
...
* [trape](https://github.com/jofpin/trape) ⭐ 8,975 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
...
* [Nitter](https://github.com/zedeus/nitter/) ⭐ 13,478 | 🐛 156 | 🌐 Nim | 📅 2026-08-22 - Alternative Twitter front-end
* [Nitter Instances](https://github.com/zedeus/nitter/wiki/Instances) ⭐ 13,478 | 🐛 156 | 🌐 Nim | 📅 2026-08-22 - List of alternative Twitter front-end instances for privacy.
...
* [Pushshift API Guide](https://github.com/pushshift/api) ⭐ 1,432 | 🐛 117 | 🌐 Python | 📅 2023-04-06 - The pushshift.io Reddit API was designed and created by the /r/datasets mod team to help provide enhanced functionality and search capabilities for searching Reddit comments and submissions.
  <br>
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,402 | 🐛 74 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,086 | 🐛 883 | 🌐 Python | 📅 2025-08-25 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,221 | 🐛 332 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,046 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,253 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,619 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,492 | 🐛 159 | 📅 2026-08-21 - A topic-centric list of HQ open datasets.
...
* [git-hound](https://github.com/tillson/git-hound) ⭐ 1,451 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Reconnaissance tool for GitHub code search. Scans for exposed API keys across all of GitHub, not just known repos and orgs.
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,732 | 🐛 2 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 6,383 | 🐛 14 | 🌐 Python | 📅 2026-08-07 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,668 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Dark Web OSINT Tool for crawling and analyzing Tor network.
* [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,285 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Tool for investigating hidden services on Tor network.
...
* [Sightline](https://github.com/ni5arga/sightline) ⭐ 558 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-10 - Geospatial intelligence platform for discovering and analyzing physical-world infrastructure using OpenStreetMap data, including military installations, telecommunications towers, power plants, airports, and 200+ infrastructure types.
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,927 | 🐛 2 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [Commix](https://github.com/commixproject/commix) ⭐ 5,822 | 🐛 4 | 🌐 Python | 📅 2026-08-22 - Automated OS command injection and exploitation tool.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,020 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,271 | 🐛 1 | 🌐 Go | 📅 2026-08-22 - Fast passive subdomain enumeration tool.
...
* [MassDNS](https://github.com/blechschmidt/massdns) ⭐ 3,636 | 🐛 14 | 🌐 C | 📅 2026-04-15 - High-performance DNS stub resolver.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,653 | 🐛 107 | 🌐 Go | 📅 2026-08-20 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,673 | 🐛 1 | 🌐 Perl | 📅 2026-08-18 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,006 | 🐛 12 | 🌐 PHP | 📅 2026-08-22 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,565 | 🐛 231 | 🌐 Go | 📅 2026-08-20 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,654 | 🐛 32 | 🌐 Python | 📅 2026-08-23 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,011 | 🐛 20 | 🌐 Go | 📅 2026-08-17 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,031 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,556 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,380 | 🐛 22 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,245 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API endpoint and content discovery tool.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,159 | 🐛 37 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,160 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - Dex to Java decompiler for Android applications.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,866 | 🐛 30 | 📅 2026-03-07 - Curated list of bug bounty resources.
