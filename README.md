...
* [Leaker](https://github.com/vflame6/leaker) ⭐ 597 | 🐛 4 | 🌐 Go | 📅 2026-09-25 - Passive leak enumeration CLI tool that searches across 10 breach databases simultaneously.
...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,762 | 🐛 201 | 🌐 Python | 📅 2026-09-17 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,997 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
* [Chiasmodon](https://github.com/chiasmod0n/chiasmodon) ⭐ 701 | 🐛 3 | 🌐 Python | 📅 2025-05-10 - Chiasmodon is an OSINT tool designed to assist in the process of gathering information about a target domain. Its primary functionality revolves around searching for domain-related data, including domain emails, domain credentials, CIDRs , ASNs , and subdomains, the tool also allows users to search Google Play application ID.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,359 | 🐛 464 | 🌐 Python | 📅 2026-09-16 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,199 | 🐛 237 | 🌐 Python | 📅 2026-09-25 - Toolkit for adding programmable guardrails to LLM applications.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,245 | 🐛 30 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,523 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-25 - Visualizer for neural network, deep learning, and ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,406 | 🐛 31 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,925 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-20 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,531 | 🐛 106 | 🌐 Go | 📅 2026-09-26 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,522 | 🐛 321 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,574 | 🐛 19 | 🌐 Go | 📅 2026-09-25 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,719 | 🐛 233 | 🌐 Go | 📅 2026-09-24 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,225 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,504 | 🐛 3 | 🌐 Go | 📅 2026-09-25 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,160 | 🐛 25 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,239 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,427 | 🐛 11 | 🌐 Go | 📅 2026-09-23 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,145 | 🐛 1 | 🌐 Shell | 📅 2026-09-26 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,088 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,579 | 🐛 5 | 🌐 Go | 📅 2026-09-12 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,402 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,939 | 🐛 39 | 🌐 Python | 📅 2024-11-01 - Full-featured web reconnaissance framework written in Python.
* [gau](https://github.com/lc/gau) ⭐ 5,101 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,033 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,796 | 🐛 8 | 🌐 Rust | 📅 2026-09-24 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,641 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
...
* [mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,868 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - A browser extension for OSINT search
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,639 | 🐛 2,685 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,740 | 🐛 12 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,758 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,091 | 🐛 221 | 🌐 Python | 📅 2026-09-25 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 10,044 | 🐛 2,163 | 🌐 TypeScript | 📅 2026-09-26 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,729 | 🐛 80 | 🌐 Python | 📅 2026-09-23 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,030 | 🐛 62 | 🌐 Python | 📅 2026-09-25 - Your everyday threat intelligence platform.
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 742 | 🐛 2 | 🌐 REXX | 📅 2026-09-26 - C2 intelligence feeds for threat hunting.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,758 | 🐛 351 | 🌐 Python | 📅 2026-09-26 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,571 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,999 | 🐛 12 | 🌐 Python | 📅 2026-09-26 - Check a username's presence across popular dev/social/creator sites and games
* [snoop](https://github.com/snooppr/snoop) ⭐ 4,036 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Snoop Project One of the most promising OSINT tools to search for nicknames. Over 4000+ sites (THE BEST ONE)
* [Nexfil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,625 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - OSINT tool for finding profiles by username.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,611 | 🐛 77 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
...
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,999 | 🐛 12 | 🌐 Python | 📅 2026-09-26 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [email2phonenumber](https://github.com/martinvigo/email2phonenumber) ⭐ 2,773 | 🐛 9 | 🌐 Python | 📅 2024-07-26 - A OSINT tool to obtain a target's phone number just by having his email address
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,686 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
* [Crosslinked](https://github.com/m8sec/CrossLinked) ⭐ 1,594 | 🐛 11 | 🌐 Python | 📅 2024-11-26 - LinkedIn enumeration to extract employee names for email generation.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,471 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - All-in-one email OSINT tool. Checks 800+ platforms via Holehe, WhatsMyName, and user-scanner, with breach detection, Hudson Rock infostealer intel, and identity clustering.
* [buster](https://github.com/sham00n/buster) ⭐ 1,417 | 🐛 34 | 🌐 Python | 📅 2020-03-26 - An advanced tool for email reconnaissance
* [Mailcat](https://github.com/sharsil/mailcat) ⭐ 944 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Find email addresses of a person from their username.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,150 | 🐛 122 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
* [Moriarty-Project](https://github.com/AzizKpln/Moriarty-Project) ⭐ 2,097 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Moriarty Project is a powerful web based phone number investigation tool. It has 6 features and it allows you to choose either all features, or the features you like
...
* [trape](https://github.com/jofpin/trape) ⭐ 9,025 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
* [Social-Media-OSINT-Tools-Collection](https://github.com/osintambition/Social-Media-OSINT-Tools-Collection) ⭐ 1,994 | 🐛 20 | 📅 2026-09-25 - A collection of most useful osint tools for SOCINT.
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,611 | 🐛 77 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,666 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,307 | 🐛 350 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,076 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
* [osi.ig](https://github.com/th3unkn0n/osi.ig) ⭐ 1,570 | 🐛 52 | 🌐 Python | 📅 2024-02-01 - Information Gathering Instagram.
* [SoIG](https://github.com/yezz123/SoIG) ⭐ 431 | 🐛 6 | 🌐 Python | 📅 2026-06-28 - OSINT Tool gets a range of information from an Instagram account
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,370 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,641 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
* [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,321 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - Metadata harvester from public documents.
* [MetaClean](https://github.com/Moresyl/metaclean) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-26 - Open-source desktop tool for inspecting and removing metadata locally from images, PDFs, Office documents, and text files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,158 | 🐛 161 | 📅 2026-09-23 - A topic-centric list of HQ open datasets.
...
* [Shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,984 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Find secrets in your code. Secrets detection for your GitHub, GitLab and Bitbucket repositories
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,843 | 🐛 3 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,413 | 🐛 90 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,344 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,950 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Dark Web OSINT Tool for crawling and analyzing Tor network.
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,952 | 🐛 11 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [Mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,868 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - Browser extension for OSINT searches on selected text.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,194 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,857 | 🐛 3 | 🌐 Python | 📅 2026-09-26 - Automated OS command injection and exploitation tool.
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,357 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and exploitation.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,225 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,504 | 🐛 3 | 🌐 Go | 📅 2026-09-25 - Fast passive subdomain enumeration tool.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,046 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool.
...
* [MassDNS](https://github.com/blechschmidt/massdns) ⭐ 3,648 | 🐛 14 | 🌐 C | 📅 2026-04-15 - High-performance DNS stub resolver.
* [DNSRecon](https://github.com/darkoperator/dnsrecon) ⭐ 3,073 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - DNS enumeration and scanning tool.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,531 | 🐛 106 | 🌐 Go | 📅 2026-09-26 - Fast vulnerability scanner based on YAML templates.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,729 | 🐛 9 | 🌐 PHP | 📅 2026-09-25 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,719 | 🐛 233 | 🌐 Go | 📅 2026-09-24 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,756 | 🐛 22 | 🌐 Python | 📅 2026-09-26 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,160 | 🐛 25 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,088 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,583 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,402 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,268 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API endpoint and content discovery tool.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,177 | 🐛 39 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,633 | 🐛 452 | 🌐 Java | 📅 2026-09-25 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,836 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-26 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,408 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - Runtime mobile exploration toolkit powered by Frida.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,912 | 🐛 31 | 📅 2026-03-07 - Curated list of bug bounty resources.
