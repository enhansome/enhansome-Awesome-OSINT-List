...
* [Leaker](https://github.com/vflame6/leaker) ⭐ 580 | 🐛 5 | 🌐 Go | 📅 2026-08-14 - Passive leak enumeration CLI tool that searches across 10 breach databases simultaneously.
...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,696 | 🐛 203 | 🌐 Python | 📅 2026-08-12 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,803 | 🐛 0 | 🌐 Python | 📅 2026-07-22 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
...
* [Garak](https://github.com/leondz/garak) ⭐ 8,850 | 🐛 394 | 🌐 Python | 📅 2026-08-17 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,970 | 🐛 225 | 🌐 Python | 📅 2026-08-19 - Toolkit for adding programmable guardrails to LLM applications.
* [AI Exploits](https://github.com/protectai/ai-exploits) ⭐ 1,746 | 🐛 3 | 🌐 Python | 📅 2024-10-23 - Collection of real-world AI/ML exploits and vulnerabilities.
* [Rebuff](https://github.com/protectai/rebuff) ⚠️ Archived - Prompt injection detector for LLM applications.
* [LLM Fuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 377 | 🐛 3 | 🌐 Python | 📅 2024-02-12 - Fuzzing framework for finding vulnerabilities in LLMs.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,184 | 🐛 18 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
* [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,468 | 🐛 18 | 🌐 Python | 📅 2026-08-15 - Framework for adversarial attacks in NLP.
...
* [TensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,022 | 🐛 135 | 🌐 Python | 📅 2026-07-08 - Library for training ML models with differential privacy.
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 936 | 🐛 25 | 🌐 Python | 📅 2025-07-18 - Generic automation layer for assessing security of ML models.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,362 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-18 - Visualizer for neural network, deep learning, and ML models.
...
* [Model Signing](https://github.com/sigstore/model-transparency) ⭐ 244 | 🐛 46 | 🌐 Python | 📅 2026-08-17 - Supply chain security for ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,298 | 🐛 33 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,536 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-11 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,588 | 🐛 106 | 🌐 Go | 📅 2026-08-17 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 21,183 | 🐛 305 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,330 | 🐛 26 | 🌐 Go | 📅 2026-08-17 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,545 | 🐛 231 | 🌐 Go | 📅 2026-07-19 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 14,991 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,226 | 🐛 8 | 🌐 Go | 📅 2026-08-12 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 13,998 | 🐛 20 | 🌐 Go | 📅 2026-08-17 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,120 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,287 | 🐛 11 | 🌐 Go | 📅 2026-08-15 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,019 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - Fast, simple, recursive content discovery tool.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 7,996 | 🐛 2 | 🌐 Shell | 📅 2026-08-12 - Automated reconnaissance tool combining multiple OSINT tools.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,527 | 🐛 7 | 🌐 Go | 📅 2026-08-08 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,380 | 🐛 21 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,859 | 🐛 38 | 🌐 Python | 📅 2024-11-01 - Full-featured web reconnaissance framework written in Python.
* [gau](https://github.com/lc/gau) ⭐ 5,065 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,538 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all URLs that the Wayback Machine knows about for a domain.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,993 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,783 | 🐛 24 | 🌐 Rust | 📅 2026-07-28 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,617 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
* [log4j-scan](https://github.com/fullhunt/log4j-scan) ⭐ 3,421 | 🐛 34 | 🌐 Python | 📅 2022-11-23 - A fully automated, accurate, and extensive scanner for finding log4j RCE CVE-2021-44228
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,153 | 🐛 37 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
* [WebSift](https://github.com/s-r-e-e-r-a-j/WebSift) ⭐ 568 | 🐛 0 | 🌐 Shell | 📅 2026-02-24 - Web reconnaissance tool for gathering information about websites.
...
* [mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,839 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - A browser extension for OSINT search
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 857 | 🐛 65 | 🌐 Go | 📅 2026-06-16 - All-In-One OSINT tool with neat web interface
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 185,425 | 🐛 2,598 | 🌐 Python | 📅 2026-08-18 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 28,158 | 🐛 2 | 📅 2026-08-18 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,695 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 10,903 | 🐛 191 | 🌐 Python | 📅 2026-08-18 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 9,827 | 🐛 2,094 | 🌐 TypeScript | 📅 2026-08-19 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,673 | 🐛 71 | 🌐 Python | 📅 2026-08-18 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,016 | 🐛 47 | 🌐 Python | 📅 2026-08-17 - Your everyday threat intelligence platform.
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 741 | 🐛 2 | 🌐 REXX | 📅 2026-08-18 - C2 intelligence feeds for threat hunting.
...
* [LinkScope](https://github.com/AccentuSoft/LinkScope_Client) ⭐ 491 | 🐛 2 | 🌐 Python | 📅 2025-03-04 - LinkScope allows you to perform online investigations by representing information as discrete pieces of data, called Entities.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 89,770 | 🐛 329 | 🌐 Python | 📅 2026-08-18 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 7,719 | 🐛 17 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [snoop](https://github.com/snooppr/snoop) ⭐ 4,007 | 🐛 1 | 🌐 Python | 📅 2026-07-30 - Snoop Project One of the most promising OSINT tools to search for nicknames. Over 4000+ sites (THE BEST ONE)
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 3,233 | 🐛 11 | 🌐 Python | 📅 2026-08-18 - Check a username's presence across popular dev/social/creator sites and games
* [Nexfil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,606 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - OSINT tool for finding profiles by username.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,383 | 🐛 73 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
* [mosint](https://github.com/alpkeskin/mosint) ⭐ 5,992 | 🐛 26 | 🌐 Go | 📅 2024-02-02 - Automated e-mail OSINT tool for gathering information about email addresses.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 3,233 | 🐛 11 | 🌐 Python | 📅 2026-08-18 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [email2phonenumber](https://github.com/martinvigo/email2phonenumber) ⭐ 2,740 | 🐛 9 | 🌐 Python | 📅 2024-07-26 - A OSINT tool to obtain a target's phone number just by having his email address
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,652 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
...
* [buster](https://github.com/sham00n/buster) ⭐ 1,383 | 🐛 34 | 🌐 Python | 📅 2020-03-26 - An advanced tool for email reconnaissance
* [Mailcat](https://github.com/sharsil/mailcat) ⭐ 930 | 🐛 0 | 🌐 Python | 📅 2026-05-24 - Find email addresses of a person from their username.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 14,849 | 🐛 111 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
* [Moriarty-Project](https://github.com/AzizKpln/Moriarty-Project) ⭐ 2,069 | 🐛 28 | 🌐 Python | 📅 2024-07-13 - Moriarty Project is a powerful web based phone number investigation tool. It has 6 features and it allows you to choose either all features, or the features you like
...
* [trape](https://github.com/jofpin/trape) ⭐ 8,968 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
* [Social-Media-OSINT-Tools-Collection](https://github.com/osintambition/Social-Media-OSINT-Tools-Collection) ⭐ 1,945 | 🐛 18 | 📅 2026-01-30 - A collection of most useful osint tools for SOCINT.
...
* [Nitter](https://github.com/zedeus/nitter/) ⭐ 13,454 | 🐛 159 | 🌐 Nim | 📅 2026-08-19 - Alternative Twitter front-end
* [Nitter Instances](https://github.com/zedeus/nitter/wiki/Instances) ⭐ 13,454 | 🐛 159 | 🌐 Nim | 📅 2026-08-19 - List of alternative Twitter front-end instances for privacy.
...
* [Pushshift API Guide](https://github.com/pushshift/api) ⭐ 1,431 | 🐛 117 | 🌐 Python | 📅 2023-04-06 - The pushshift.io Reddit API was designed and created by the /r/datasets mod team to help provide enhanced functionality and search capabilities for searching Reddit comments and submissions.
  <br>
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,383 | 🐛 73 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [GitDorker](https://github.com/obheda12/GitDorker) ⭐ 2,575 | 🐛 22 | 🌐 Python | 📅 2024-08-03 - A Python program to scrape secrets from GitHub through usage of a large repository of dorks.
  <br>
* [Google Dork Cheatsheet](https://github.com/robyfirnandoyusuf/Google-Dork-Cheatsheet) ⭐ 55 | 🐛 0 | 📅 2022-04-11 - google dorks cheatsheet
...
* [DiscordOSINT](https://github.com/atoncehussein/DiscordOSINT) ⭐ 587 | 🐛 0 | 📅 2024-08-08 - This repository contains useful resources to conduct research and OSINT investigations on Discord accounts ,servers and bots
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,033 | 🐛 884 | 🌐 Python | 📅 2025-08-25 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,204 | 🐛 329 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,040 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
* [osi.ig](https://github.com/th3unkn0n/osi.ig) ⭐ 1,549 | 🐛 52 | 🌐 Python | 📅 2024-02-01 - Information Gathering Instagram.
* [SoIG](https://github.com/yezz123/SoIG) ⭐ 412 | 🐛 6 | 🌐 Python | 📅 2026-06-28 - OSINT Tool gets a range of information from an Instagram account
* [insto](https://github.com/subzeroid/insto) ⭐ 90 | 🐛 1 | 🌐 Python | 📅 2026-06-20 - Interactive Instagram OSINT CLI (REPL + one-shot) with watch/diff snapshots and Maltego-ready CSV/JSON export; pluggable HikerAPI/aiograpi backends.
* [insta-dl](https://github.com/subzeroid/insta-dl) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-08-15 - Async Instagram downloader CLI for profiles, posts, reels, stories, highlights, hashtags, and comments with JSON metadata, original timestamps, and pluggable HikerAPI/aiograpi backends.
...
* [maltego-telegram](https://github.com/vognik/maltego-telegram/) ⭐ 549 | 🐛 3 | 🌐 Python | 📅 2026-01-27 - OSINT Maltego Transforms for investigating Telegram channels, groups, and users, including deanonymization via stickers, forwarded messages, similar channels, deleted posts, and more.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,237 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,617 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
* [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,310 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - Metadata harvester from public documents.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,142 | 🐛 159 | 📅 2026-08-04 - A topic-centric list of HQ open datasets.
...
* [Shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,976 | 🐛 34 | 🌐 JavaScript | 📅 2025-02-28 - Find secrets in your code. Secrets detection for your GitHub, GitLab and Bitbucket repositories
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,714 | 🐛 2 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,304 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 6,356 | 🐛 14 | 🌐 Python | 📅 2026-08-07 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,632 | 🐛 8 | 🌐 Python | 📅 2026-07-28 - Dark Web OSINT Tool for crawling and analyzing Tor network.
* [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,280 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Tool for investigating hidden services on Tor network.
...
* [Sightline](https://github.com/ni5arga/sightline) ⭐ 531 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-10 - Geospatial intelligence platform for discovering and analyzing physical-world infrastructure using OpenStreetMap data, including military installations, telecommunications towers, power plants, airports, and 200+ infrastructure types.
...
* [analytics-engine](https://github.com/mashiox/analytics-engine) ⭐ 41 | 🐛 2 | 🌐 PLpgSQL | 📅 2023-03-23 - An environment of open source services used for market analysis
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,924 | 🐛 0 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [Mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,839 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - Browser extension for OSINT searches on selected text.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,143 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,819 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Automated OS command injection and exploitation tool.
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,342 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and exploitation.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 14,991 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,226 | 🐛 8 | 🌐 Go | 📅 2026-08-12 - Fast passive subdomain enumeration tool.
...
* [DNSRecon](https://github.com/darkoperator/dnsrecon) ⭐ 3,059 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - DNS enumeration and scanning tool.
...
* [Shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,660 | 🐛 4 | 🌐 Go | 📅 2026-08-17 - Wrapper around massdns for subdomain bruteforcing.
* [Chaos](https://chaos.projectdiscovery.io/) - Project Discovery's internet-wide asset dataset.

### Vulnerability Scanning

* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,588 | 🐛 106 | 🌐 Go | 📅 2026-08-17 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,665 | 🐛 1 | 🌐 Perl | 📅 2026-08-18 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 72,919 | 🐛 12 | 🌐 PHP | 📅 2026-08-18 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,545 | 🐛 231 | 🌐 Go | 📅 2026-07-19 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,641 | 🐛 28 | 🌐 Python | 📅 2026-08-16 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 13,998 | 🐛 20 | 🌐 Go | 📅 2026-08-17 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,019 | 🐛 44 | 🌐 Rust | 📅 2026-04-15 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,555 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,122 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,610 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-17 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,325 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - Runtime mobile exploration toolkit powered by Frida.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,861 | 🐛 30 | 📅 2026-03-07 - Curated list of bug bounty resources.
