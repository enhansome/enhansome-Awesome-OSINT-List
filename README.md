...
* [Leaker](https://github.com/vflame6/leaker) ⭐ 595 | 🐛 4 | 🌐 Go | 📅 2026-09-11 - Passive leak enumeration CLI tool that searches across 10 breach databases simultaneously.
...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,761 | 🐛 200 | 🌐 Python | 📅 2026-09-17 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,985 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
* [Chiasmodon](https://github.com/chiasmod0n/chiasmodon) ⭐ 699 | 🐛 3 | 🌐 Python | 📅 2025-05-10 - Chiasmodon is an OSINT tool designed to assist in the process of gathering information about a target domain. Its primary functionality revolves around searching for domain-related data, including domain emails, domain credentials, CIDRs , ASNs , and subdomains, the tool also allows users to search Google Play application ID.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,342 | 🐛 459 | 🌐 Python | 📅 2026-09-16 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,184 | 🐛 235 | 🌐 Python | 📅 2026-09-24 - Toolkit for adding programmable guardrails to LLM applications.
...
* [LLM Fuzzer](https://github.com/mnns/LLMFuzzer) ⭐ 378 | 🐛 3 | 🌐 Python | 📅 2024-02-12 - Fuzzing framework for finding vulnerabilities in LLMs.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,245 | 🐛 29 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
* [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,471 | 🐛 21 | 🌐 Python | 📅 2026-08-15 - Framework for adversarial attacks in NLP.
* [Foolbox](https://github.com/bethgelab/foolbox) ⭐ 2,975 | 🐛 29 | 🌐 Python | 📅 2025-12-03 - Python toolbox to create adversarial examples.
...
* [TensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,036 | 🐛 136 | 🌐 Python | 📅 2026-08-26 - Library for training ML models with differential privacy.
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 939 | 🐛 26 | 🌐 Python | 📅 2025-07-18 - Generic automation layer for assessing security of ML models.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,520 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-24 - Visualizer for neural network, deep learning, and ML models.
...
* [Model Signing](https://github.com/sigstore/model-transparency) ⭐ 246 | 🐛 48 | 🌐 Python | 📅 2026-09-21 - Supply chain security for ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,401 | 🐛 31 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,907 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-20 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,475 | 🐛 109 | 🌐 Go | 📅 2026-09-24 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,478 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,558 | 🐛 22 | 🌐 Go | 📅 2026-09-23 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,708 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,211 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,494 | 🐛 6 | 🌐 Go | 📅 2026-09-24 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,152 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,233 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,423 | 🐛 11 | 🌐 Go | 📅 2026-09-23 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,139 | 🐛 1 | 🌐 Shell | 📅 2026-09-22 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,082 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,575 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,398 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,936 | 🐛 39 | 🌐 Python | 📅 2024-11-01 - Full-featured web reconnaissance framework written in Python.
* [gau](https://github.com/lc/gau) ⭐ 5,099 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
...
* [ivre](https://github.com/ivre/ivre) ⭐ 4,152 | 🐛 53 | 🌐 Python | 📅 2026-09-10 - Network recon framework to build alternatives to Shodan/ZoomEye/Censys.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,030 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,794 | 🐛 7 | 🌐 Rust | 📅 2026-09-23 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,636 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
* [log4j-scan](https://github.com/fullhunt/log4j-scan) ⭐ 3,425 | 🐛 34 | 🌐 Python | 📅 2022-11-23 - A fully automated, accurate, and extensive scanner for finding log4j RCE CVE-2021-44228
...
* [WebSift](https://github.com/s-r-e-e-r-a-j/WebSift) ⭐ 585 | 🐛 0 | 🌐 Shell | 📅 2026-02-24 - Web reconnaissance tool for gathering information about websites.
...
* [mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,864 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - A browser extension for OSINT search
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 877 | 🐛 65 | 🌐 Go | 📅 2026-06-16 - All-In-One OSINT tool with neat web interface
* [NullSec Linux](https://github.com/bad-antics/nullsec-linux) ⭐ 84 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - Security-focused Linux distribution with 135+ pre-configured OSINT and security tools for penetration testing and reconnaissance.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,275 | 🐛 2,673 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,708 | 🐛 0 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,757 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,087 | 🐛 227 | 🌐 Python | 📅 2026-09-24 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 10,040 | 🐛 2,148 | 🌐 TypeScript | 📅 2026-09-23 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,729 | 🐛 76 | 🌐 Python | 📅 2026-09-23 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,029 | 🐛 61 | 🌐 Python | 📅 2026-09-23 - Your everyday threat intelligence platform.
* [APTnotes](https://github.com/aptnotes/data) ⭐ 1,816 | 🐛 32 | 📅 2024-12-16 - APTnotes is a repository of publicly-available papers and blogs (sorted by year) related to malicious campaigns/activity/software that have been associated with vendor-defined APT (Advanced Persistent Threat) groups and/or tool-sets.
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 742 | 🐛 2 | 🌐 REXX | 📅 2026-09-24 - C2 intelligence feeds for threat hunting.
...
* [LinkScope](https://github.com/AccentuSoft/LinkScope_Client) ⭐ 497 | 🐛 2 | 🌐 Python | 📅 2025-03-04 - LinkScope allows you to perform online investigations by representing information as discrete pieces of data, called Entities.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,560 | 🐛 350 | 🌐 Python | 📅 2026-09-24 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,539 | 🐛 15 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,984 | 🐛 8 | 🌐 Python | 📅 2026-09-22 - Check a username's presence across popular dev/social/creator sites and games
* [snoop](https://github.com/snooppr/snoop) ⭐ 4,035 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Snoop Project One of the most promising OSINT tools to search for nicknames. Over 4000+ sites (THE BEST ONE)
* [Nexfil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,623 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - OSINT tool for finding profiles by username.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,597 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
* [mosint](https://github.com/alpkeskin/mosint) ⭐ 6,035 | 🐛 28 | 🌐 Go | 📅 2024-02-02 - Automated e-mail OSINT tool for gathering information about email addresses.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,984 | 🐛 8 | 🌐 Python | 📅 2026-09-22 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [email2phonenumber](https://github.com/martinvigo/email2phonenumber) ⭐ 2,768 | 🐛 9 | 🌐 Python | 📅 2024-07-26 - A OSINT tool to obtain a target's phone number just by having his email address
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,684 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
* [Crosslinked](https://github.com/m8sec/CrossLinked) ⭐ 1,593 | 🐛 11 | 🌐 Python | 📅 2024-11-26 - LinkedIn enumeration to extract employee names for email generation.
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,450 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - All-in-one email OSINT tool. Checks 800+ platforms via Holehe, WhatsMyName, and user-scanner, with breach detection, Hudson Rock infostealer intel, and identity clustering.
* [buster](https://github.com/sham00n/buster) ⭐ 1,415 | 🐛 34 | 🌐 Python | 📅 2020-03-26 - An advanced tool for email reconnaissance
* [Mailcat](https://github.com/sharsil/mailcat) ⭐ 941 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Find email addresses of a person from their username.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,133 | 🐛 121 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
* [Moriarty-Project](https://github.com/AzizKpln/Moriarty-Project) ⭐ 2,094 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Moriarty Project is a powerful web based phone number investigation tool. It has 6 features and it allows you to choose either all features, or the features you like
...
* [trape](https://github.com/jofpin/trape) ⭐ 9,024 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
* [Social-Media-OSINT-Tools-Collection](https://github.com/osintambition/Social-Media-OSINT-Tools-Collection) ⭐ 1,991 | 🐛 20 | 📅 2026-01-30 - A collection of most useful osint tools for SOCINT.
...
* [Nitter](https://github.com/zedeus/nitter/) ⚠️ Archived - Alternative Twitter front-end
* [Nitter Instances](https://github.com/zedeus/nitter/wiki/Instances) ⚠️ Archived - List of alternative Twitter front-end instances for privacy.
...
* [Pushshift API Guide](https://github.com/pushshift/api) ⭐ 1,435 | 🐛 118 | 🌐 Python | 📅 2023-04-06 - The pushshift.io Reddit API was designed and created by the /r/datasets mod team to help provide enhanced functionality and search capabilities for searching Reddit comments and submissions.
  <br>
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,597 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [GitDorker](https://github.com/obheda12/GitDorker) ⭐ 2,589 | 🐛 22 | 🌐 Python | 📅 2024-08-03 - A Python program to scrape secrets from GitHub through usage of a large repository of dorks.
  <br>
* [Google Dork Cheatsheet](https://github.com/robyfirnandoyusuf/Google-Dork-Cheatsheet) ⭐ 62 | 🐛 0 | 📅 2022-04-11 - google dorks cheatsheet
...
* [DiscordOSINT](https://github.com/atoncehussein/DiscordOSINT) ⭐ 599 | 🐛 0 | 📅 2024-08-08 - This repository contains useful resources to conduct research and OSINT investigations on Discord accounts ,servers and bots
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,630 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,302 | 🐛 350 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,073 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
* [osi.ig](https://github.com/th3unkn0n/osi.ig) ⭐ 1,570 | 🐛 52 | 🌐 Python | 📅 2024-02-01 - Information Gathering Instagram.
* [SoIG](https://github.com/yezz123/SoIG) ⭐ 427 | 🐛 6 | 🌐 Python | 📅 2026-06-28 - OSINT Tool gets a range of information from an Instagram account
* [insto](https://github.com/subzeroid/insto) ⭐ 116 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Interactive Instagram OSINT CLI (REPL + one-shot) with watch/diff snapshots and Maltego-ready CSV/JSON export; pluggable HikerAPI/aiograpi backends.
* [insta-dl](https://github.com/subzeroid/insta-dl) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Async Instagram downloader CLI for profiles, posts, reels, stories, highlights, hashtags, and comments with JSON metadata, original timestamps, and pluggable HikerAPI/aiograpi backends.
...
* [maltego-telegram](https://github.com/vognik/maltego-telegram/) ⭐ 569 | 🐛 3 | 🌐 Python | 📅 2026-01-27 - OSINT Maltego Transforms for investigating Telegram channels, groups, and users, including deanonymization via stickers, forwarded messages, similar channels, deleted posts, and more.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,368 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,636 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
* [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,319 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - Metadata harvester from public documents.
* [MetaClean](https://github.com/Moresyl/metaclean) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Open-source desktop tool for inspecting and removing metadata locally from images, PDFs, Office documents, and text files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,131 | 🐛 160 | 📅 2026-09-23 - A topic-centric list of HQ open datasets.
...
* [Shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,983 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Find secrets in your code. Secrets detection for your GitHub, GitLab and Bitbucket repositories
* [git-hound](https://github.com/tillson/git-hound) ⭐ 1,462 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Reconnaissance tool for GitHub code search. Scans for exposed API keys across all of GitHub, not just known repos and orgs.
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,841 | 🐛 3 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,404 | 🐛 90 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
* [aptnotes/data](https://github.com/aptnotes/data) ⭐ 1,816 | 🐛 32 | 📅 2024-12-16 - APTnotes is a repository of publicly-available papers and blogs (sorted by year) related to malicious campaigns/activity/software that have been associated with vendor-defined APT (Advanced Persistent Threat) groups and/or tool-sets.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,320 | 🐛 1 | 🌐 Python | 📅 2026-09-24 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,938 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Dark Web OSINT Tool for crawling and analyzing Tor network.
* [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,304 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Tool for investigating hidden services on Tor network.
...
* [Sightline](https://github.com/ni5arga/sightline) ⭐ 567 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-10 - Geospatial intelligence platform for discovering and analyzing physical-world infrastructure using OpenStreetMap data, including military installations, telecommunications towers, power plants, airports, and 200+ infrastructure types.
...
* [analytics-engine](https://github.com/mashiox/analytics-engine) ⭐ 44 | 🐛 2 | 🌐 PLpgSQL | 📅 2023-03-23 - An environment of open source services used for market analysis
...
* [LELU](https://github.com/the-legal-aid-society/LELU) ⭐ 11 | 🐛 0 | 📅 2026-09-14 - Data from Legal Aid Society's Law Enforcement Lookup
  <br>
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,950 | 🐛 10 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [Mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,864 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - Browser extension for OSINT searches on selected text.
* [OSINT-SPY](https://github.com/SharadKumar97/OSINT-SPY) ⭐ 1,550 | 🐛 13 | 🌐 Python | 📅 2023-10-23 - Chrome extension for performing OSINT searches.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,188 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,857 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Automated OS command injection and exploitation tool.
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,353 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and exploitation.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,211 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,494 | 🐛 6 | 🌐 Go | 📅 2026-09-24 - Fast passive subdomain enumeration tool.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,044 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool.
* [Knock](https://github.com/guelfoweb/knock) ⭐ 4,199 | 🐛 72 | 🌐 Python | 📅 2026-02-19 - Python tool to enumerate subdomains.
...
* [MassDNS](https://github.com/blechschmidt/massdns) ⭐ 3,646 | 🐛 14 | 🌐 C | 📅 2026-04-15 - High-performance DNS stub resolver.
* [DNSRecon](https://github.com/darkoperator/dnsrecon) ⭐ 3,071 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - DNS enumeration and scanning tool.
* [Fierce](https://github.com/mschwager/fierce) ⭐ 1,812 | 🐛 9 | 🌐 Python | 📅 2024-08-28 - DNS reconnaissance tool for locating non-contiguous IP space.
* [Shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,671 | 🐛 4 | 🌐 Go | 📅 2026-09-23 - Wrapper around massdns for subdomain bruteforcing.
* [Chaos](https://chaos.projectdiscovery.io/) - Project Discovery's internet-wide asset dataset.

### Vulnerability Scanning

* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,475 | 🐛 109 | 🌐 Go | 📅 2026-09-24 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,739 | 🐛 1 | 🌐 Perl | 📅 2026-09-23 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,690 | 🐛 10 | 🌐 PHP | 📅 2026-09-23 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,708 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,752 | 🐛 24 | 🌐 Python | 📅 2026-09-23 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,152 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,082 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,582 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,398 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,266 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API endpoint and content discovery tool.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,173 | 🐛 39 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,602 | 🐛 450 | 🌐 Java | 📅 2026-09-12 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,824 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,403 | 🐛 58 | 🌐 Python | 📅 2026-09-17 - Runtime mobile exploration toolkit powered by Frida.
...
* [Faraday](https://github.com/infobyte/faraday) ⭐ 6,748 | 🐛 16 | 🌐 Python | 📅 2026-09-17 - Collaborative penetration test and vulnerability management platform.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,909 | 🐛 30 | 📅 2026-03-07 - Curated list of bug bounty resources.
