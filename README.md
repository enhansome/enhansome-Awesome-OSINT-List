...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,743 | 🐛 204 | 🌐 Python | 📅 2026-09-10 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,917 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,185 | 🐛 421 | 🌐 Python | 📅 2026-09-09 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,102 | 🐛 228 | 🌐 Python | 📅 2026-09-10 - Toolkit for adding programmable guardrails to LLM applications.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,221 | 🐛 25 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
...
* [TensorFlow Privacy](https://github.com/tensorflow/privacy) ⭐ 2,033 | 🐛 136 | 🌐 Python | 📅 2026-08-26 - Library for training ML models with differential privacy.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,467 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-11 - Visualizer for neural network, deep learning, and ML models.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,748 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-10 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,108 | 🐛 107 | 🌐 Go | 📅 2026-09-10 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,028 | 🐛 324 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,464 | 🐛 34 | 🌐 Go | 📅 2026-09-10 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,663 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,142 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,416 | 🐛 61 | 🌐 Go | 📅 2026-09-09 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,106 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,185 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,385 | 🐛 9 | 🌐 Go | 📅 2026-09-10 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,086 | 🐛 7 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,063 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,557 | 🐛 11 | 🌐 Go | 📅 2026-08-08 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
...
* [ivre](https://github.com/ivre/ivre) ⭐ 4,139 | 🐛 52 | 🌐 Python | 📅 2026-09-10 - Network recon framework to build alternatives to Shodan/ZoomEye/Censys.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,021 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,793 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,631 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
...
* [mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,853 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - A browser extension for OSINT search
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 867 | 🐛 65 | 🌐 Go | 📅 2026-06-16 - All-In-One OSINT tool with neat web interface
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,305 | 🐛 2,646 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,273 | 🐛 2 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,732 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,018 | 🐛 202 | 🌐 Python | 📅 2026-09-07 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 9,930 | 🐛 2,142 | 🌐 TypeScript | 📅 2026-09-11 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,707 | 🐛 72 | 🌐 Python | 📅 2026-09-10 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,027 | 🐛 55 | 🌐 Python | 📅 2026-09-08 - Your everyday threat intelligence platform.
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 741 | 🐛 2 | 🌐 REXX | 📅 2026-09-11 - C2 intelligence feeds for threat hunting.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 91,255 | 🐛 346 | 🌐 Python | 📅 2026-09-11 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,037 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,749 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - Check a username's presence across popular dev/social/creator sites and games
* [snoop](https://github.com/snooppr/snoop) ⭐ 4,025 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Snoop Project One of the most promising OSINT tools to search for nicknames. Over 4000+ sites (THE BEST ONE)
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,540 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
...
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,749 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [email2phonenumber](https://github.com/martinvigo/email2phonenumber) ⭐ 2,759 | 🐛 9 | 🌐 Python | 📅 2024-07-26 - A OSINT tool to obtain a target's phone number just by having his email address
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,673 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
* [Crosslinked](https://github.com/m8sec/CrossLinked) ⭐ 1,589 | 🐛 11 | 🌐 Python | 📅 2024-11-26 - LinkedIn enumeration to extract employee names for email generation.
* [buster](https://github.com/sham00n/buster) ⭐ 1,409 | 🐛 34 | 🌐 Python | 📅 2020-03-26 - An advanced tool for email reconnaissance
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,043 | 🐛 114 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
* [Moriarty-Project](https://github.com/AzizKpln/Moriarty-Project) ⭐ 2,085 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Moriarty Project is a powerful web based phone number investigation tool. It has 6 features and it allows you to choose either all features, or the features you like
...
* [trape](https://github.com/jofpin/trape) ⭐ 8,997 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
* [Social-Media-OSINT-Tools-Collection](https://github.com/osintambition/Social-Media-OSINT-Tools-Collection) ⭐ 1,971 | 🐛 18 | 📅 2026-01-30 - A collection of most useful osint tools for SOCINT.
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,540 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [GitDorker](https://github.com/obheda12/GitDorker) ⭐ 2,581 | 🐛 22 | 🌐 Python | 📅 2024-08-03 - A Python program to scrape secrets from GitHub through usage of a large repository of dorks.
  <br>
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,374 | 🐛 884 | 🌐 Python | 📅 2026-09-10 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,273 | 🐛 344 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,058 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
...
* [insto](https://github.com/subzeroid/insto) ⭐ 107 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Interactive Instagram OSINT CLI (REPL + one-shot) with watch/diff snapshots and Maltego-ready CSV/JSON export; pluggable HikerAPI/aiograpi backends.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,331 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,631 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,901 | 🐛 159 | 📅 2026-09-10 - A topic-centric list of HQ open datasets.
...
* [Shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,981 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Find secrets in your code. Secrets detection for your GitHub, GitLab and Bitbucket repositories
* [git-hound](https://github.com/tillson/git-hound) ⭐ 1,456 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Reconnaissance tool for GitHub code search. Scans for exposed API keys across all of GitHub, not just known repos and orgs.
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,375 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,094 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,834 | 🐛 9 | 🌐 Python | 📅 2026-09-04 - Dark Web OSINT Tool for crawling and analyzing Tor network.
* [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,298 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Tool for investigating hidden services on Tor network.
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,943 | 🐛 6 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [Mitaka](https://github.com/ninoseki/mitaka) ⭐ 1,853 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - Browser extension for OSINT searches on selected text.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,175 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,838 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Automated OS command injection and exploitation tool.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,142 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,416 | 🐛 61 | 🌐 Go | 📅 2026-09-09 - Fast passive subdomain enumeration tool.
...
* [Assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,675 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain.
...
* [Shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,671 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - Wrapper around massdns for subdomain bruteforcing.
* [Chaos](https://chaos.projectdiscovery.io/) - Project Discovery's internet-wide asset dataset.

### Vulnerability Scanning

* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,108 | 🐛 107 | 🌐 Go | 📅 2026-09-10 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,722 | 🐛 1 | 🌐 Perl | 📅 2026-09-11 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,432 | 🐛 8 | 🌐 PHP | 📅 2026-09-10 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,663 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,712 | 🐛 23 | 🌐 Python | 📅 2026-09-11 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,106 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,063 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,576 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,398 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,260 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API endpoint and content discovery tool.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,170 | 🐛 38 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of web archives.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,410 | 🐛 446 | 🌐 Java | 📅 2026-09-08 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,747 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,379 | 🐛 57 | 🌐 Python | 📅 2026-07-23 - Runtime mobile exploration toolkit powered by Frida.
...
* [Faraday](https://github.com/infobyte/faraday) ⭐ 6,733 | 🐛 17 | 🌐 Python | 📅 2026-09-04 - Collaborative penetration test and vulnerability management platform.
...
* [Awesome Bug Bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,899 | 🐛 30 | 📅 2026-03-07 - Curated list of bug bounty resources.
