...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,758 | 🐛 198 | 🌐 Python | 📅 2026-09-17 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,969 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,318 | 🐛 451 | 🌐 Python | 📅 2026-09-16 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,175 | 🐛 234 | 🌐 Python | 📅 2026-09-18 - Toolkit for adding programmable guardrails to LLM applications.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,238 | 🐛 28 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
* [TextAttack](https://github.com/QData/TextAttack) ⭐ 3,472 | 🐛 20 | 🌐 Python | 📅 2026-08-15 - Framework for adversarial attacks in NLP.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,505 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-20 - Visualizer for neural network, deep learning, and ML models.
...
* [Model Signing](https://github.com/sigstore/model-transparency) ⭐ 244 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - Supply chain security for ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,392 | 🐛 31 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,882 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-20 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,392 | 🐛 106 | 🌐 Go | 📅 2026-09-21 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,435 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,541 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,701 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,197 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,470 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,141 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,218 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
...
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,127 | 🐛 7 | 🌐 Shell | 📅 2026-09-05 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,078 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,574 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,398 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,926 | 🐛 39 | 🌐 Python | 📅 2024-11-01 - Full-featured web reconnaissance framework written in Python.
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,028 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,794 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,637 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Tool to find metadata and hidden information in the documents.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,425 | 🐛 2,664 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,658 | 🐛 1 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,753 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,069 | 🐛 219 | 🌐 Python | 📅 2026-09-20 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 10,026 | 🐛 2,157 | 🌐 TypeScript | 📅 2026-09-21 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,725 | 🐛 69 | 🌐 Python | 📅 2026-09-18 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,029 | 🐛 57 | 🌐 Python | 📅 2026-09-14 - Your everyday threat intelligence platform.
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 742 | 🐛 2 | 🌐 REXX | 📅 2026-09-21 - C2 intelligence feeds for threat hunting.
...
* [LinkScope](https://github.com/AccentuSoft/LinkScope_Client) ⭐ 498 | 🐛 2 | 🌐 Python | 📅 2025-03-04 - LinkScope allows you to perform online investigations by representing information as discrete pieces of data, called Entities.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,330 | 🐛 350 | 🌐 Python | 📅 2026-09-21 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,492 | 🐛 16 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,947 | 🐛 13 | 🌐 Python | 📅 2026-09-20 - Check a username's presence across popular dev/social/creator sites and games
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,584 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
...
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,947 | 🐛 13 | 🌐 Python | 📅 2026-09-20 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
...
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,423 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - All-in-one email OSINT tool. Checks 800+ platforms via Holehe, WhatsMyName, and user-scanner, with breach detection, Hudson Rock infostealer intel, and identity clustering.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,102 | 🐛 116 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
...
* [trape](https://github.com/jofpin/trape) ⭐ 9,015 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,584 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,480 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,298 | 🐛 348 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,065 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
...
* [insto](https://github.com/subzeroid/insto) ⭐ 116 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Interactive Instagram OSINT CLI (REPL + one-shot) with watch/diff snapshots and Maltego-ready CSV/JSON export; pluggable HikerAPI/aiograpi backends.
...
* [maltego-telegram](https://github.com/vognik/maltego-telegram/) ⭐ 568 | 🐛 3 | 🌐 Python | 📅 2026-01-27 - OSINT Maltego Transforms for investigating Telegram channels, groups, and users, including deanonymization via stickers, forwarded messages, similar channels, deleted posts, and more.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,358 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,637 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - Metadata analysis tool for documents and files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,070 | 🐛 160 | 📅 2026-09-18 - A topic-centric list of HQ open datasets.
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,837 | 🐛 3 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,210 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,916 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Dark Web OSINT Tool for crawling and analyzing Tor network.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,191 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,851 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Automated OS command injection and exploitation tool.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,197 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,470 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,392 | 🐛 106 | 🌐 Go | 📅 2026-09-21 - Fast vulnerability scanner based on YAML templates.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,648 | 🐛 10 | 🌐 PHP | 📅 2026-09-20 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,701 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,743 | 🐛 23 | 🌐 Python | 📅 2026-09-19 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,141 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,078 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,580 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer for brute-forcing.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,544 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,800 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-21 - Automated mobile application security testing framework.
* [Objection](https://github.com/sensepost/objection) ⭐ 9,402 | 🐛 57 | 🌐 Python | 📅 2026-09-17 - Runtime mobile exploration toolkit powered by Frida.
