...
* [Leaker](https://github.com/vflame6/leaker) ⭐ 594 | 🐛 4 | 🌐 Go | 📅 2026-09-11 - Passive leak enumeration CLI tool that searches across 10 breach databases simultaneously.
...
* [dangerzone](https://github.com/freedomofpress/dangerzone) ⭐ 5,759 | 🐛 199 | 🌐 Python | 📅 2026-09-17 - Take potentially dangerous PDFs, office documents, or images and convert them to safe PDFs
* [Tookie-osint](https://github.com/alfredredbird/tookie-osint) ⭐ 2,977 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Tookie is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
...
* [Garak](https://github.com/leondz/garak) ⭐ 9,333 | 🐛 459 | 🌐 Python | 📅 2026-09-16 - LLM vulnerability scanner for probing language models.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,180 | 🐛 235 | 🌐 Python | 📅 2026-09-21 - Toolkit for adding programmable guardrails to LLM applications.
...
* [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) ⭐ 6,243 | 🐛 29 | 🌐 Python | 📅 2025-12-12 - Python library for adversarial machine learning.
...
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,509 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 - Visualizer for neural network, deep learning, and ML models.
...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,396 | 🐛 31 | 📅 2024-08-19 - ML tools and resources for cybersecurity.
...
* [web-check](https://github.com/Lissy93/web-check) ⭐ 34,897 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-20 - All-in-one OSINT tool for analysing any website.
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,446 | 🐛 108 | 🌐 Go | 📅 2026-09-22 - Fast vulnerability scanner based on simple YAML templates.
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,458 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Automated OSINT collection tool with 200+ modules for reconnaissance.
* [Katana](https://github.com/projectdiscovery/katana) ⭐ 17,550 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - Next-generation crawling and spidering framework.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,705 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,205 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery tool.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,486 | 🐛 7 | 🌐 Go | 📅 2026-09-22 - Fast passive subdomain enumeration tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,150 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,227 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,422 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - Fast and multi-purpose HTTP toolkit for probing web servers.
* [Reconftw](https://github.com/six2dez/reconftw) ⭐ 8,137 | 🐛 1 | 🌐 Shell | 📅 2026-09-22 - Automated reconnaissance tool combining multiple OSINT tools.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,079 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
* [Osmedeus](https://github.com/j3ssie/osmedeus) ⭐ 6,577 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Osmedeus is a Workflow Engine for Offensive Security. It was designed to build a foundation with the capability and flexibility that allows you to build your own reconnaissance system and run it on a large number of targets.
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,398 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery tool.
* [Recon-ng](https://github.com/lanmaster53/recon-ng) ⭐ 5,934 | 🐛 39 | 🌐 Python | 📅 2024-11-01 - Full-featured web reconnaissance framework written in Python.
* [gau](https://github.com/lc/gau) ⭐ 5,095 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault, Wayback Machine, and Common Crawl.
...
* [ivre](https://github.com/ivre/ivre) ⭐ 4,152 | 🐛 52 | 🌐 Python | 📅 2026-09-10 - Network recon framework to build alternatives to Shodan/ZoomEye/Censys.
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,031 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,794 | 🐛 6 | 🌐 Rust | 📅 2026-09-17 - Fast domain recognition tool with screenshotting, port scan, and subdomain monitoring.
  <br>
...
* [WebSift](https://github.com/s-r-e-e-r-a-j/WebSift) ⭐ 584 | 🐛 0 | 🌐 Shell | 📅 2026-02-24 - Web reconnaissance tool for gathering information about websites.
...
* [Seekr](https://github.com/seekr-osint/seekr) ⭐ 876 | 🐛 65 | 🌐 Go | 📅 2026-06-16 - All-In-One OSINT tool with neat web interface
* [NullSec Linux](https://github.com/bad-antics/nullsec-linux) ⭐ 83 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - Security-focused Linux distribution with 135+ pre-configured OSINT and security tools for penetration testing and reconnaissance.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,039 | 🐛 2,667 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
...
* [jivoi/awesome-osint](https://github.com/jivoi/awesome-osint) ⭐ 29,689 | 🐛 2 | 📅 2026-09-09 - A curated list of amazingly awesome OSINT
* [sinwindie/OSINT](https://github.com/sinwindie/OSINT) ⭐ 3,755 | 🐛 8 | 🌐 Python | 📅 2023-06-30 - Collections of tools and methods created to aid in OSINT collection
...
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,080 | 🐛 222 | 🌐 Python | 📅 2026-09-22 - Generic signature format for SIEM systems.
* [OpenCTI](https://github.com/OpenCTI-Platform/opencti) ⭐ 10,035 | 🐛 2,156 | 🌐 TypeScript | 📅 2026-09-23 - Open cyber threat intelligence platform.
* [intelowlproject/IntelOwl](https://github.com/intelowlproject/IntelOwl) ⭐ 4,726 | 🐛 86 | 🌐 Python | 📅 2026-09-22 - manage your Threat Intelligence at scale
* [YETI](https://github.com/yeti-platform/yeti) ⭐ 2,029 | 🐛 60 | 🌐 Python | 📅 2026-09-21 - Your everyday threat intelligence platform.
...
* [C2IntelFeeds](https://github.com/drb-ra/C2IntelFeeds) ⭐ 742 | 🐛 2 | 🌐 REXX | 📅 2026-09-23 - C2 intelligence feeds for threat hunting.
...
* [sherlock](https://github.com/sherlock-project/sherlock) ⭐ 92,512 | 🐛 350 | 🌐 Python | 📅 2026-09-23 - Hunt down social media accounts by username across social networks
* [Blackbird](https://github.com/p1ngul1n0/blackbird) ⭐ 8,526 | 🐛 15 | 🌐 Python | 📅 2025-07-13 - OSINT tool to search for accounts by username across social networks.
* [user-scanner](https://github.com/kaifcodec/user-scanner) ⭐ 4,978 | 🐛 8 | 🌐 Python | 📅 2026-09-22 - Check a username's presence across popular dev/social/creator sites and games
* [snoop](https://github.com/snooppr/snoop) ⭐ 4,034 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Snoop Project One of the most promising OSINT tools to search for nicknames. Over 4000+ sites (THE BEST ONE)
* [Nexfil](https://github.com/thewhiteh4t/nexfil) ⭐ 2,621 | 🐛 8 | 🌐 Python | 📅 2023-09-30 - OSINT tool for finding profiles by username.
...
* [Ghunt](https://github.com/mxrch/GHunt) ⭐ 19,591 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework to extract information from Google accounts.
* [mosint](https://github.com/alpkeskin/mosint) ⭐ 6,034 | 🐛 28 | 🌐 Go | 📅 2024-02-02 - Automated e-mail OSINT tool for gathering information about email addresses.
* [user-scanner](https://github.com/kaifcodec/user-scanner.git) ⭐ 4,978 | 🐛 8 | 🌐 Python | 📅 2026-09-22 - Takes an email, scan on various popular sites, games and retrieve info if the email is registered there or not.
* [email2phonenumber](https://github.com/martinvigo/email2phonenumber) ⭐ 2,765 | 🐛 9 | 🌐 Python | 📅 2024-07-26 - A OSINT tool to obtain a target's phone number just by having his email address
* [WhatBreach](https://github.com/Ekultek/WhatBreach) ⭐ 1,681 | 🐛 16 | 🌐 Python | 📅 2025-08-14 - OSINT tool to find breached emails, databases, pastes, and relevant information
...
* [MailAccess](https://github.com/KatrielMoses/MailAccess) ⭐ 1,444 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - All-in-one email OSINT tool. Checks 800+ platforms via Holehe, WhatsMyName, and user-scanner, with breach detection, Hudson Rock infostealer intel, and identity clustering.
...
* [GhostTrack](https://github.com/HunxByts/GhostTrack) ⭐ 15,115 | 🐛 122 | 🌐 Python | 📅 2024-01-11 - Useful tool to track location or mobile number.
* [Moriarty-Project](https://github.com/AzizKpln/Moriarty-Project) ⭐ 2,093 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Moriarty Project is a powerful web based phone number investigation tool. It has 6 features and it allows you to choose either all features, or the features you like
...
* [trape](https://github.com/jofpin/trape) ⭐ 9,022 | 🐛 255 | 🌐 Python | 📅 2024-06-20 - People tracker on the Internet: OSINT analysis and research tool.
  <br>
...
* [GHunt](https://github.com/mxrch/GHunt) ⭐ 19,591 | 🐛 76 | 🌐 Python | 📅 2026-04-10 - Offensive Google framework.
...
* [Osintgram](https://github.com/Datalux/Osintgram) ⭐ 14,610 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Osintgram is a OSINT tool on Instagram. It offers an interactive shell to perform analysis on Instagram account of any users by its nickname
* [toutatis](https://github.com/megadose/toutatis) ⭐ 4,301 | 🐛 349 | 🌐 Python | 📅 2024-12-05 - Extract information from Instagram accounts such as e-mails, phone numbers and more.
  <br>
* [yesitsme](https://github.com/blackeko/yesitsme) ⭐ 3,068 | 🐛 26 | 🌐 Python | 📅 2024-08-17 - Simple OSINT script to find Instagram profiles by name and e-mail/phone
* [osi.ig](https://github.com/th3unkn0n/osi.ig) ⭐ 1,568 | 🐛 52 | 🌐 Python | 📅 2024-02-01 - Information Gathering Instagram.
* [SoIG](https://github.com/yezz123/SoIG) ⭐ 426 | 🐛 6 | 🌐 Python | 📅 2026-06-28 - OSINT Tool gets a range of information from an Instagram account
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,365 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for embedded file extraction.
...
* [MetaClean](https://github.com/Moresyl/metaclean) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Open-source desktop tool for inspecting and removing metadata locally from images, PDFs, Office documents, and text files.
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,105 | 🐛 160 | 📅 2026-09-22 - A topic-centric list of HQ open datasets.
...
* [metabigor](https://github.com/j3ssie/metabigor) ⭐ 1,840 | 🐛 3 | 🌐 Go | 📅 2026-08-08 - OSINT tools and more but without API key
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,403 | 🐛 89 | 🌐 Python | 📅 2026-09-14 - A repository of LIVE malwares for your own joy and pleasure. theZoo is a project created to make the possibility of malware analysis open and available to the public.
...
* [robin](https://github.com/apurvsinghgautam/robin) ⭐ 7,302 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - AI-Powered Dark Web OSINT Tool for investigation and analysis.
* [TorBot](https://github.com/DedSecInside/TorBot) ⭐ 4,930 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Dark Web OSINT Tool for crawling and analyzing Tor network.
* [OnionScan](https://github.com/s-rah/onionscan) ⭐ 3,303 | 🐛 86 | 🌐 Go | 📅 2024-08-09 - Tool for investigating hidden services on Tor network.
...
* [On-Chain-Investigations-Tools-List](https://github.com/OffcierCia/On-Chain-Investigations-Tools-List) ⭐ 1,949 | 🐛 10 | 📅 2026-06-03 - Comprehensive list of tools for investigating crypto hacks and security incidents.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,187 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Advanced XSS detection and exploitation suite.
* [Commix](https://github.com/commixproject/commix) ⭐ 5,854 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - Automated OS command injection and exploitation tool.
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,352 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and exploitation.
...
* [Amass](https://github.com/owasp-amass/amass) ⭐ 15,205 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth attack surface mapping and asset discovery.
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,486 | 🐛 7 | 🌐 Go | 📅 2026-09-22 - Fast passive subdomain enumeration tool.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,043 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool.
...
* [Shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,670 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - Wrapper around massdns for subdomain bruteforcing.
* [Chaos](https://chaos.projectdiscovery.io/) - Project Discovery's internet-wide asset dataset.

### Vulnerability Scanning

* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,446 | 🐛 108 | 🌐 Go | 📅 2026-09-22 - Fast vulnerability scanner based on YAML templates.
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,738 | 🐛 1 | 🌐 Perl | 📅 2026-09-23 - Web server scanner for dangerous files and outdated software.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,676 | 🐛 10 | 🌐 PHP | 📅 2026-09-22 - Collection of multiple types of lists for security assessments.
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,705 | 🐛 234 | 🌐 Go | 📅 2026-09-09 - Fast web fuzzer written in Go.
* [Dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,752 | 🐛 23 | 🌐 Python | 📅 2026-09-23 - Web path scanner and directory brute-forcing tool.
* [Gobuster](https://github.com/OJ/gobuster) ⭐ 14,150 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/file, DNS and VHost busting tool.
* [Feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,079 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - Fast, simple, recursive content discovery tool.
...
* [Jadx](https://github.com/skylot/jadx) ⭐ 50,575 | 🐛 449 | 🌐 Java | 📅 2026-09-12 - Dex to Java decompiler for Android applications.
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,815 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - Automated mobile application security testing framework.
